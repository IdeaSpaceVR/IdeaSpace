jQuery(document).ready(function($) {
		...
		tinymce.init({
  			selector: '.field-type-textarea',  
				...
				font_formats: 'Andale Mono=andale mono,times;Arial=arial,helvetica,sans-serif;Arial Black=arial black,avant garde;Bangers=bangers;Book Antiqua=book antiqua,palatino;Bungee Shade=bungee shade;Codystar=codystar;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier;Dr Sugiyama=dr sugiyama;Georgia=georgia,palatino;Helvetica=helvetica;Indie Flower=indie flower;Impact=impact,chicago;Lobster=lobster;Pacifico=pacifico;Skranji=skranji;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco;Times New Roman=times new roman,times;Verdana=verdana,geneva'
		});

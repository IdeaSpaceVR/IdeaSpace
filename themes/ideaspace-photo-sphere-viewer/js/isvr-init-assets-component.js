AFRAME.registerComponent('isvr-init-assets', {
    ...
    responseHandler: function() {
        ...
        if (this.xmlhttp.readyState == 4 && this.xmlhttp.status == 200) {
            ...
            photosphere_image.src = obj['photo-sphere'][0]['photo-sphere']['#uri']['#value'];


            /* photo sphere thumbnail assets */
            for (var i=0; i<obj['photo-sphere'].length; i++) {
                ...
                photosphere_thumb_image.onload = (function(id, i) {
                    return function() {
                        ...
                        if (document.querySelector('#img-photosphere-' + id) == null) {
                            ...
                            photosphere_image.src = obj['photo-sphere'][i]['photo-sphere']['#uri']['#value'];
                ...
                photosphere_thumb_image.src = obj['photo-sphere'][i]['photo-sphere']['photo-sphere-navigation-preview-image']['#uri']['#value'];

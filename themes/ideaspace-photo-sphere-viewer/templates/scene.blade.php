...
@section('scene')
    ...
    @include('theme::assets')
        ...
        <a-entity data-current-page="1" isvr-photosphere-menu id="photosphere-menu" visible="false">
            ...
            @endif
            @if (count($content['photo-sphere']) > 1) 
            ...
            @endif
            @if (count($content['photo-sphere']) > 2) 
            ...
            @endif
            @if (count($content['photo-sphere']) > 3) 
            <a-entity isvr-photosphere-menu-navigation="url:{{ $space_url }}/content/photo-sphere?per-page=3&page=2" id="menu-arrow-down" position="0 -1.5 0" visible="@if (count($content['photo-sphere']) > 3) true @else false @endif" geometry="primitive: plane; width: 1; height: 0.5" material="transparent: true; opacity: 0">
                <a-plane position="-0.07 0 0" rotation="0 0 45" width="0.10" height="0.3" color="#0080e5"></a-plane>
                <a-plane position="0.07 0 0" rotation="0 0 -45" width="0.10" height="0.3" color="#0080e5"></a-plane>
            </a-entity>
            @endif
        ...
        <a-entity 
            isvr-init-assets="url:{{ $space_url }}/content/photo-sphere?per-page=3&page=1"

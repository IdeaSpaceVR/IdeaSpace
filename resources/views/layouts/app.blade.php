            ...
            <div class="collapse navbar-collapse" id="spark-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        ...
                        <li class="hidden-lg hidden-md hidden-sm" role="presentation"><a href="{{ route('asset_library_images') }}"><i class="fa fa-btn fa-image"></i> Assets</a></li>
        ...
        <div class="row">
            ...
            <div class="col-xs-1" id="sidebar-nav" role="navigation">
                <ul class="nav nav-stacked sidebar-nav">
                    ...
                    <li><a href="{{ route('asset_library_images') }}"><i class="fa fa-btn fa-image"></i> Assets</a></li>

<div class="form-group {{ $errors->has($field_id)?'has-error':'' }}">
    ...
    @elseif ($form['#contentformat'] == App\Content\FieldTypeTextfield::CONTENTFORMAT_HTML_TEXT)
        ...
        {!! Form::text($field_id, $form['#content']['#value'], array('class'=>'form-control input-lg group-field-type-textfield', 'placeholder'=> $form['#description'], 'maxlength' => $form['#maxlength'])) !!}
				@else

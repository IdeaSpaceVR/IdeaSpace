<div class="form-group {{ $errors->has($field_id)?'has-error':'' }}">
    ...
    @elseif ($form['#contentformat'] == App\Content\FieldTypeTextarea::CONTENTFORMAT_HTML_TEXT)
        ...
        {!! Form::textarea($field_id, $form['#content']['#value'], array('class'=>'form-control input-lg group-field-type-textarea', 'placeholder'=> $form['#description'], 'rows' => $form['#rows'], 'maxlength' => $form['#maxlength'])) !!}
				@else

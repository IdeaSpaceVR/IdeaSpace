<div id="{{ $field_id }}" class="form-group {{ $errors->has($field_id)?'has-error':'' }}">
    ...
    <div class="form-control-add-file text-center {{ $errors->has($field_id)?'has-error':'' }}">
        ...
        <input type="hidden" value="" name="{{ $field_id }}" class="video-id">
        ...
        <div class="video-edit" style="display:none">
            <div class="video-placeholder" style="margin-bottom:10px"><video class="edit img-thumbnail center-block" width="300" height="auto" preload="metadata"><source src="" type="video/mp4"></video></div>
...
@push('field_type_scripts')
    <script src="{{ asset('public/assets/admin/space/content/js/field_video_add.js') }}" type="text/javascript"></script>
@endpush

    ...
    <div class="modal-dialog modal-lg" role="document" style="width:96%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="modal-title">Assets <button style="margin-left:20px;margin-bottom:6px;" class="btn btn-primary btn-sm" type="button" id="add-new-asset">Add New</button></h2>
            </div>

...
<body style="background-color:#000000">
  ...
  <a-scene>
    ...
    <a-entity text="text: 500 Internal Server Error" material="color: #fff" position="-3.9 0 -2005"></a-entity>
    <a-entity id="back" visible="false" rotation="0 180 0" text="text: 500 Internal Server Error" material="color: #fff" position="3.9 0 -1995"></a-entity>

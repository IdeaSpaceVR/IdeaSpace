...
class FieldTypeRotationController extends Controller {


    private $fieldTypeRotation;


    /**
     * Create a new controller instance.
     *
     * @param FieldTypeRotation $ftr
     *
     * @return void
     */
    public function __construct(FieldTypeRotation $ftr) {

        $this->middleware('auth');
        $this->fieldTypeRotation = $ftr;
    }


    /**
     * The add/edit rotation page.
     *
     * @param int $space_id 
     ...
     * @return Response
     */
    public function rotation_subject($space_id, $contenttype, $subject_type, $subject_id = NULL) {
        ...
        if ($subject_type == ContentType::FIELD_TYPE_MODEL3D && !is_null($subject_id)) {
            ...
            switch (strtolower($pathinfo['extension'])) {
                ...
                case Model3D::FILE_EXTENSION_GLTF:            
                    $template = $this->fieldTypeRotation->subjectTypeTemplates[$subject_type . '__' . Model3D::FILE_EXTENSION_GLTF];
                ...
                case Model3D::FILE_EXTENSION_GLB:            
                    $template = $this->fieldTypeRotation->subjectTypeTemplates[$subject_type . '__' . Model3D::FILE_EXTENSION_GLB];
                    $model_data = json_decode($model3d->data, true);
                    $scale = '0 0 0';
                    $rotation_x = '0';
                    $rotation_y = '0';
                ...
                case Model3D::FILE_EXTENSION_PLY:            
                    $template = $this->fieldTypeRotation->subjectTypeTemplates[$subject_type . '__' . Model3D::FILE_EXTENSION_PLY];
                    $model_data = json_decode($model3d->data, true);
                    $scale = '0 0 0';
                    $rotation_x = '0';
                    $rotation_y = '0';
            ...
            $template = $this->fieldTypeRotation->subjectTypeTemplates[$subject_type];
            return view($template, $vars);       
            ...
            $template = $this->fieldTypeRotation->subjectTypeTemplates[FieldTypeRotation::NONE];
            $vars = [];
            return view($template, $vars);       
        }
